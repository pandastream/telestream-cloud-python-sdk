...
class CreateVideoBody(object):
    ...
    def __init__(self, source_url=None, profiles=None, payload=None, pipeline=None, subtitle_files=None, extra_files=None, extra_variables=None, path_format=None, clip_end=None, clip_length=None, clip_offset=None):  # noqa: E501
