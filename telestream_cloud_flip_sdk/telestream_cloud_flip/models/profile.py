...
class Profile(object):
    ...
    def aspect_mode(self):
        ...
        Specifies an aspect mode for output videos. The following options are available:   - letterbox:   - pad: Add paddings to the input image. Default is \"letterbox\".  # noqa: E501
