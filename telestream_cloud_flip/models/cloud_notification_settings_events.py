...
class CloudNotificationSettingsEvents(object):
    ...
    def __init__(self, encoding_completed=None, encoding_progress=None, video_created=None, video_encoded=None):
        """
        CloudNotificationSettingsEvents - a model defined in Swagger
        """
    ...
    def encoding_completed(self):
        """
        Gets the encoding_completed of this CloudNotificationSettingsEvents.
        If set to `true`, a notification will be sent after an encoding becomes complete.

        :return: The encoding_completed of this CloudNotificationSettingsEvents.
        :rtype: bool
        """
    ...
    def encoding_completed(self, encoding_completed):
        ...
        :param encoding_completed: The encoding_completed of this CloudNotificationSettingsEvents.
        :type: bool
        """
        if encoding_completed is None:
            raise ValueError("Invalid value for `encoding_completed`, must not be `None`")
    ...
    def encoding_progress(self):
        """
        Gets the encoding_progress of this CloudNotificationSettingsEvents.
        If set to `true`, a notification will be sent after an encoding's progess changes.

        :return: The encoding_progress of this CloudNotificationSettingsEvents.
        :rtype: bool
        """
    ...
    def encoding_progress(self, encoding_progress):
        ...
        :param encoding_progress: The encoding_progress of this CloudNotificationSettingsEvents.
        :type: bool
        """
        if encoding_progress is None:
            raise ValueError("Invalid value for `encoding_progress`, must not be `None`")
    ...
    def video_created(self):
        """
        Gets the video_created of this CloudNotificationSettingsEvents.
        If set to `true`, a notification will be sent after a video is created.

        :return: The video_created of this CloudNotificationSettingsEvents.
        :rtype: bool
        """
    ...
    def video_created(self, video_created):
        ...
        :param video_created: The video_created of this CloudNotificationSettingsEvents.
        :type: bool
        """
        if video_created is None:
            raise ValueError("Invalid value for `video_created`, must not be `None`")
    ...
    def video_encoded(self):
        """
        Gets the video_encoded of this CloudNotificationSettingsEvents.
        If set to `true`, a notification will be sent after a video is encoded.

        :return: The video_encoded of this CloudNotificationSettingsEvents.
        :rtype: bool
        """
    ...
    def video_encoded(self, video_encoded):
        ...
        :param video_encoded: The video_encoded of this CloudNotificationSettingsEvents.
        :type: bool
        """
        if video_encoded is None:
            raise ValueError("Invalid value for `video_encoded`, must not be `None`")
