...
class Job(object):
    ...
    def __init__(self, id=None, project_id=None, status=None, state=None, duration=None, type=None, progress=None, filename=None, source_url=None, created_at=None, updated_at=None, error_class=None, error_message=None, payload=None, details=None, local_vars_configuration=None):  # noqa: E501
