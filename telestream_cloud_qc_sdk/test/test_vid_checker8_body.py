...
from telestream_cloud_qc.models.vid_checker8_body import VidChecker8Body  # noqa: E501
from telestream_cloud_qc.rest import ApiException

class TestVidChecker8Body(unittest.TestCase):
    """VidChecker8Body unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test VidChecker8Body
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = telestream_cloud_qc.models.vid_checker8_body.VidChecker8Body()  # noqa: E501
        if include_optional :
            return VidChecker8Body(
                name = '0', 
                template = '0', 
